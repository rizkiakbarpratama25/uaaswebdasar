...
<div class="container mt-5">
    <h2>Data Absensi</h2>
    <a href="tambah.php" class="btn btn-success mb-2">Tambah Absensi</a>
    <table class="table">
        <thead>
            <tr>
                <th>No</th>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='edit.php?id_absensi=" . $row['id_absensi'] . "' class='btn btn-warning btn-sm'>Edit</a>
                            <a href='hapus.php?id_absensi=" . $row['id_absensi'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data?\")'>Hapus</a>
                        </td>";
                    echo "</tr>";
                }
            } else {
